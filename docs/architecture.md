...
- `src/spreadsheet/engine/` contains the React-independent workbook core: sheets, sparse cells, a headless controller, commands, undo/redo, clipboard helpers, dependency graph utilities, and snapshot serialization.
